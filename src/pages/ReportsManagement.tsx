...
const mockReports: Report[] = [
  ...
  },
  {
    id: 3,
    folio: 'FOL-1043',
    fecha_subida: '2025-01-14 10:20:00',
    fecha_consulta: '2025-01-12',
    centro_salud: 'Hospital General de Cajeme',
    municipio: 'Cajeme',
    distrito: 'Distrito 2',
    diagnostico: 'Influenza',
    edad_paciente: 45,
    sexo: 'M',
    usuario_subida: 'hospital_cajeme',
    estado: 'procesado'
  },
  {
    id: 4,
    folio: 'FOL-1042',
    fecha_subida: '2025-01-13 09:15:00',
    fecha_consulta: '2025-01-10',
    centro_salud: 'Centro de Salud Nogales',
    municipio: 'Nogales',
    distrito: 'Distrito 3',
    diagnostico: 'Dengue',
    edad_paciente: 22,
    sexo: 'F',
    usuario_subida: 'centro_nogales',
    estado: 'procesado'
  },
  {
    id: 5,
    folio: 'FOL-1041',
    fecha_subida: '2025-01-12 11:30:00',
    fecha_consulta: '2025-01-08',
    centro_salud: 'Hospital General San Luis Río Colorado',
    municipio: 'San Luis Río Colorado',
    distrito: 'Distrito 4',
    diagnostico: 'Zika',
    edad_paciente: 31,
    sexo: 'F',
    usuario_subida: 'hospital_slrc',
    estado: 'procesado'
  },
  {
    id: 6,
    folio: 'FOL-1040',
    fecha_subida: '2025-01-11 15:45:00',
    fecha_consulta: '2025-01-11',
    centro_salud: 'Centro de Salud Guaymas',
    municipio: 'Guaymas',
    distrito: 'Distrito 2',
    diagnostico: 'COVID-19',
    edad_paciente: 56,
    sexo: 'M',
    usuario_subida: 'centro_guaymas',
    estado: 'procesado'
  },
  {
    id: 7,
    folio: 'FOL-1039',
    fecha_subida: '2025-01-10 08:20:00',
    fecha_consulta: '2025-01-09',
    centro_salud: 'Clínica del IMSS Navojoa',
    municipio: 'Navojoa',
    distrito: 'Distrito 2',
    diagnostico: 'Influenza',
    edad_paciente: 19,
    sexo: 'F',
    usuario_subida: 'clinica_navojoa',
    estado: 'procesado'
  },
  {
    id: 8,
    folio: 'FOL-1038',
    fecha_subida: '2025-01-09 13:10:00',
    fecha_consulta: '2025-01-08',
    centro_salud: 'Centro de Salud Agua Prieta',
    municipio: 'Agua Prieta',
    distrito: 'Distrito 3',
    diagnostico: 'Dengue',
    edad_paciente: 41,
    sexo: 'M',
    usuario_subida: 'centro_agua_prieta',
    estado: 'procesado'
  },
  {
    id: 9,
    folio: 'FOL-1037',
    fecha_subida: '2025-01-08 17:25:00',
    fecha_consulta: '2025-01-07',
    centro_salud: 'Hospital General Puerto Peñasco',
    municipio: 'Puerto Peñasco',
    distrito: 'Distrito 4',
    diagnostico: 'COVID-19',
    edad_paciente: 38,
    sexo: 'F',
    usuario_subida: 'hospital_puerto_penasco',
    estado: 'procesado'
  },
  {
    id: 10,
    folio: 'FOL-1036',
    fecha_subida: '2025-01-07 12:40:00',
    fecha_consulta: '2025-01-06',
    centro_salud: 'Centro de Salud Caborca',
    municipio: 'Caborca',
    distrito: 'Distrito 4',
    diagnostico: 'Chikungunya',
    edad_paciente: 29,
    sexo: 'M',
    usuario_subida: 'centro_caborca',
    estado: 'procesado'
  },
  {
    id: 11,
    folio: 'FOL-1035',
    fecha_subida: '2025-01-06 14:55:00',
    fecha_consulta: '2025-01-05',
    centro_salud: 'Centro de Salud Cananea',
    municipio: 'Cananea',
    distrito: 'Distrito 5',
    diagnostico: 'Influenza',
    edad_paciente: 67,
    sexo: 'F',
    usuario_subida: 'centro_cananea',
    estado: 'procesado'
  },
  {
    id: 12,
    folio: 'FOL-1034',
    fecha_subida: '2025-01-05 16:30:00',
    fecha_consulta: '2025-01-04',
    centro_salud: 'Centro de Salud Magdalena',
    municipio: 'Magdalena',
    distrito: 'Distrito 3',
    diagnostico: 'Dengue',
    edad_paciente: 25,
    sexo: 'F',
    usuario_subida: 'centro_magdalena',
    estado: 'procesado'
  },
  {
    id: 13,
    folio: 'FOL-1033',
    fecha_subida: '2025-01-04 11:15:00',
  ...
  },
  {
    id: 14,
    folio: 'FOL-1032',
    fecha_subida: '2025-01-03 09:45:00',
  ...
  },
  {
    id: 15,
    folio: 'FOL-1031',
    fecha_subida: '2025-01-02 15:20:00',
