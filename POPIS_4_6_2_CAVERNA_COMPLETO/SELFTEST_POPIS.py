...
def main() -> int:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        write_tsv(
            ...
            make_rows(2026, range(1, 13), "26") + make_rows(2026, range(53, 54), "26F"),
        )
        ...
        current = base[(base["Año"].eq(2026)) & pd.to_numeric(base["SemanaInicio"], errors="coerce").le(12)]
        ...
        assert discover_assets(root).cutoff_week == 13
